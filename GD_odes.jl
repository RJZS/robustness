...
# Sodium current
mNainf(V,r=25.) = Xinf(V,r,-5.); tau_mNa(V,r=100.) = tauX(V,0.75,0.5,r,-20.)
hNainf(V,r=40.) = Xinf(V,r,10.); tau_hNa(V,r=50.) = tauX(V,4.0,3.5,r,-20.)
...
# Calcium currents
mCaLinf(V,r=45.) = Xinf(V,r,-5.); tau_mCaL(V,r=30.) = tauX(V,6.0,5.5,r,-20.)

mCaTinf(V,r=60) = Xinf(V,r,-5.); tau_mCaT(V,r=30.) = tauX(V,6.0,5.5,r,-20.)
hCaTinf(V,r=85) = Xinf(V,r,10.); tau_hCaT(V,r=30.) = 100*tauX(V,6.0,5.5,r,-20.)
