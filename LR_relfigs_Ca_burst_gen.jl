...
# Derived from '_new_burst_gen' but only learning the two bursting/'calcium' currents.
...
max_alpha_error = 0.1 # Mismatch on afn and asp in the reliability experiments.
...
save("sec4_LR_Ca_burst_withstep.jld","noise",noise,
